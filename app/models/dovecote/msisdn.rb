module Dovecote
  class Msisdn
    ...
    def initialize(phone_number, country_code = nil)
      ...
      if msisdn = self.class.normalize_phone_number(phone_number, country_code)
    ...
    def self.country_code_to_phone_code(country_code)
      return unless country_code
      Dovecote::Msisdn::PhoneCodes.detect { |phone_code, country_codes| country_codes.include?(country_code.to_sym) }.try(:first)
    end

    def self.normalize_phone_number(phone_number, country_code)
